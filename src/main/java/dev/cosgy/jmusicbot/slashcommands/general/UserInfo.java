...
public class UserInfo extends SlashCommand {
    ...
    protected void execute(SlashCommandEvent event) {
        ...
        log.debug("\nUser Name:" + memb.getEffectiveName() + "\n" +
        ...
        if (ROLES.length() > 0)
            ...
            ROLES = "This server has no roles";
        ...
        eb.setAuthor(memb.getUser().getName() + TAG + " User Info", null, null)
                ...
                .addField(":video_game: Currently Playing", "**" + GAME + "**", true)
        ...
        if (!AVATAR.equals("No avatar")) {
            eb.setAuthor(memb.getUser().getName() + TAG + " User Info", null, AVATAR);
        }
    ...
    public void execute(CommandEvent event) {
        ...
        eb.setAuthor(memb.getUser().getName() + TAG + " User Info", null, null)
                ...
                .addBlankField(false)
                .addField(":signal_strength: Current Status", "**" + STATUS + "**", true)
                .addField(":video_game: Game Playing", "**" + GAME + "**", true)
                .addField(":tools: Roles", "**" + ROLES + "**", true)
                .addBlankField(false)
                .addField(":inbox_tray: Server Join Date", "**" + GUILD_JOIN_DATE + "**", true)
                .addField(":beginner: Account Creation Date", "**" + DISCORD_JOINED_DATE + "**", true)
